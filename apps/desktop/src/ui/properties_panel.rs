use crate::editor::{
    Clip, EditClipAudioCommand, EditClipBlendModeCommand, EditClipTextCommand,
    EditClipTransformCommand, EditorCore,
};
...
impl PropertiesPanel {
            ...
            match active_tab {
                crate::ui::workspace::RightTab::Transform => {
                    container = container
                        ...
                        .child(self.render_control_group(
                            "縮放 (Scale)",
                            ...
                            self.render_action_btn("scale-dec", "- 0.1", {
                                ...
                                move |cx| {
                                    ...
                                    let new_val =
                                        Some((old_val.unwrap_or(1.0) - 0.1).clamp(0.1, 3.0));
                        ...
                        .child(self.render_control_group(
                            ...
                            self.render_action_btn("posx-dec", "左移 50", {
                                ...
                                move |cx| {
                                    ...
                                    let new_val = Some(
                                        (old_val.unwrap_or(0.0) - 50.0).clamp(-1000.0, 1000.0),
                                    );
                                    let cmd = EditClipTransformCommand::new(
                                        clip_id.clone(),
                                        clip.scale,
                            ...
                            .child(self.render_control_group(
                                ...
                                self.render_action_btn("vol-dec", "- 10%", {
                                    ...
                                    move |cx| {
                                        ...
                                        let new_vol =
                                            Some((old_vol.unwrap_or(1.0) - 0.1).clamp(0.0, 2.0));
                            ...
                            .child(self.render_control_group(
                                ...
                                self.render_action_btn("fadein-dec", "- 0.5s", {
                                    ...
                                    move |cx| {
                                        ...
                                        let new_fade =
                                            Some((old_fade.unwrap_or(0.0) - 0.5).clamp(0.0, 10.0));
                                        let cmd = EditClipAudioCommand::new(
                                            clip_id.clone(),
                                            clip.volume,
                                            clip.volume,
                ...
                crate::ui::workspace::RightTab::Speed => {
                    container = container.child(self.render_control_group(
                        "播放速度 (Speed - Mock)",
                        "1.0x".to_string(),
                        ...
                        .child(self.render_control_group(
                            ...
                            self.render_action_btn("opacity-dec", "- 10%", {
                                ...
                                move |cx| {
                                    ...
                                    let new_val =
                                        Some((old_val.unwrap_or(1.0) - 0.1).clamp(0.0, 1.0));
                                    let cmd = EditClipTransformCommand::new(
                                        clip_id.clone(),
                                        clip.scale,
                                        clip.scale,
                    ...
                    container = container
                        .child(
                            div()
                                ...
                                .child(self.render_reset_btn("filter-reset", {
                                    let core = core_clone.clone();
                                    let clip_id = clip_id.clone();
                                    let clip = clip.clone();
                                    move |cx| {
                        ...
                        .child(
                            div()
                                ...
                                .child(self.render_reset_btn("transition-reset", {
                                    let core = core_clone.clone();
                                    let clip_id = clip_id.clone();
                                    let clip = clip.clone();
                                    move |cx| {
                    ...
                    .children(if selected_clip_id.is_some() {
                        ...
                        Some(
                            div()
                                ...
                                .child(div().text_xs().text_color(rgb(0x8e8e93)).child("取消選取")),
                        )
                    } else {
                        None
                    }),
    ...
    fn render_control_group(
        ...
        title: &'static str,
        value: String,
        btn_dec: impl IntoElement,
        btn_inc: impl IntoElement,
        btn_reset: impl IntoElement,
    ) -> impl IntoElement {
        div()
            .flex()
            .flex_col()
    ...
    where
        F: Fn(&mut gpui::App) + 'static + Send + Sync,
    {
        div()
            .id(id)
            .flex_1()
